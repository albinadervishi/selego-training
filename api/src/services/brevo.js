...
const SENDER_NAME = "EventHub";
const SENDER_NAME_SMS = "EventHub";
const SENDER_EMAIL = "albinadervishi0@gmail.com";

const regexp_exception_staging = /selego\.co|example\.com|gmail\.com/;
